...
bool SDMMCFS::begin(const char *mountpoint, bool mode1bit, bool format_if_mount_failed, int sdmmc_frequency, uint8_t maxOpenFiles) {
  ...
  // PATCH: perimanSetBusDeinit not implemented for SDMMC bus types in this version
  ...
  // PATCH: perimanSetPinBus not implemented for SDMMC bus types in this version
